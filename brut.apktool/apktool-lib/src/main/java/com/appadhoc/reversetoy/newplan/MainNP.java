package com.appadhoc.reversetoy.newplan;
...
public class MainNP extends Main{
...
private static final String ARG_HELP = "--help";
    ...
    public static void main(String[] args) {
        ...
        String[] arg = new String[]{"/Users/dongyuangui/Desktop/apk-blue/AbTestDemo-debug.apk"};
        m.run(arg);
    }

    private static void setRunningLocation(MainNP m) {
...
//      configFile = new File(mRunningLocation + File.separator + TypedValue.CONFIG_FILE);
            configFile = new File("/Users/dongyuangui/GITHUB/AndResGuard/tool_output/config.xml");
